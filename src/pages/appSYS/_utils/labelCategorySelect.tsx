...
import { LabelCategoryGetListAsync } from '@/services/openApi/LabelCategory';
...
const getData = ({ Filter, Sorting, SkipCount, MaxResultCount }: any) => {
    return LabelCategoryGetListAsync({
...
const LabelCategorySelect = (props: SelectProps<any> & { disabledKeys?: any[]; showId?: boolean; code: boolean }, ref) => {
...
export default React.forwardRef(LabelCategorySelect);
