...
const ApplicationPermissionModal = (props: any) => {
    ...
    return (<>
        ...
        <Modal
            ...
            <PermissionTree permissionCheck={setGrantedPermissions} providerName={"C"} providerKey={entityId} />
        </Modal>
    </>);
}

export default ApplicationPermissionModal
