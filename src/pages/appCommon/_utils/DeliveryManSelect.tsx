...
import { DeliveryManGetListAsync } from '@/services/common/DeliveryMan';
...
const getData = ({ Filter, Sorting, SkipCount, MaxResultCount }: any) => {
	return DeliveryManGetListAsync({
 ...
 * @returns
 */
const DeliveryManSelect = (props: SelectProps<any>, ref) => {
...
export default React.forwardRef(DeliveryManSelect);
