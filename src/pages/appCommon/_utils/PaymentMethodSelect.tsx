...
import { PaymentMethodGetListAsync } from '@/services/common/PaymentMethod';
...
const getData = ({ Filter, SkipCount, MaxResultCount, Sorting }: any) => {
  return PaymentMethodGetListAsync({
  ...
  return (
    <span ref={ref}>
      <DialogSelect
        ...
        request={getData}
        columnDefs={[
          { field: 'code', headerName: '付款方式代码', width: 120 },
          { field: 'name', headerName: '付款方式名称', width: 150 },
...
export default React.forwardRef(PaymentMethodSelect);