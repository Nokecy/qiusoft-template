...
import { LabelTypeGetListAsync } from '@/services/openApi/LabelType';
...
const LabelTypeSelect = (props: SelectProps<any> & { disabledKeys?: any[]; showId?: boolean; code: boolean }, ref) => {
...
export default React.forwardRef(LabelTypeSelect);
