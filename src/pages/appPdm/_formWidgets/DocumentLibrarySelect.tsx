...
const DocumentLibrarySelectComponent: React.FC<DocumentLibrarySelectProps> = props => {
...
export const DocumentLibrarySelect = DocumentLibrarySelectComponent;
export default DocumentLibrarySelectComponent;
