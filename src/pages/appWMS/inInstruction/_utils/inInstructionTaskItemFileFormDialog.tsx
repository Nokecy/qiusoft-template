...
import { formId, formSchema } from "./inInstructionTaskItemFileSchema";
import { InInstructionOrderLpnItemUpdateAttachmentAsync } from '@/services/wms/InInstructionOrderLpnItem';
 ...
 * @returns 
 */
const InInstructionTaskItemFileFormDialog = (props: any) => {
        ...
        <Button type={"primary"} onClick={() => {
            ...
            formDialog1
                .forConfirm((payload, next) => {
                    ...
                    return InInstructionOrderLpnItemUpdateAttachmentAsync({ id: entityId }, { attachments: values.attachmentsCopy }).then(() => { if (onAfterSubmit) onAfterSubmit(); next(payload) });
                })
                .open(formProps);
        }}
            {...buttonProps}
...
export default InInstructionTaskItemFileFormDialog