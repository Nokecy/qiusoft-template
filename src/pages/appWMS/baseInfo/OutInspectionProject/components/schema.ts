...
export const formId: string = "Wms.OutInspectionProject";
      ...
      "zteu89ub6jt": {
        ...
        "properties": {
          ...
          "w7fapntoi4p": {
            ...
            "properties": {
              "outInspectionProjectCheckers": {
                "type": "array",
                "x-decorator": "FormItem",
                "x-component": "ArrayTable",
                "x-validator": [],
                "x-component-props": { "gridKey": "appWMS.baseInfo.OutInspectionProject.components.schema.1" },
                "x-decorator-props": {},
                "title": "数据校验列表",
                "name": "outInspectionProjectCheckers",
