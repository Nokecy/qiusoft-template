...
import { WMSProviderGetInInstructionProviderList } from '@/services/wms/WMSProvider';
import NewDialogSelect from '@/components/newDialogSelect';
const { Option } = AntSelect;

const getData = ({ Filter, Sorting, SkipCount, MaxResultCount }: any) => {
    return WMSProviderGetInInstructionProviderList({
 ...
 * @returns 
 */
const InstructionConfigSelect = (props: SelectProps<any>, ref) => {
...
export default React.forwardRef(InstructionConfigSelect);
