...
export const formId: string = 'Pdm.RationalizationProposal';
          ...
          col1: {
            ...
            properties: {
              proposalTitle: {
                ...
                'x-component': 'Input',
                'x-component-props': { placeholder: '请输入建议主题' },
                required: true,
                name: 'proposalTitle',
              },
            },
          ...
          col7: {
            ...
            properties: {
              tasks: {
                ...
                'x-decorator': 'FormItem',
                'x-component-props': {
                  gridKey: 'rationalizationProposal.tasks',
