import { WMSProviderGetBarCodeResolverProviderList } from '@/services/wms/WMSProvider';
...
const getData = (value: string, wareHouseId?: any) => {
    return WMSProviderGetBarCodeResolverProviderList({  });
};

const ProductionDateProviderSelect = (props: SelectProps<any>, ref) => {
    const { } = props;
...
export default React.forwardRef(ProductionDateProviderSelect);