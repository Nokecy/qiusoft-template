...
const LabelTypeAdvancedSettingFormDialog = (props: any) => {
  ...
  const portalId = `labelManagement.labelTypeAdvancedSetting.${entityId}`;
...
export default LabelTypeAdvancedSettingFormDialog;
