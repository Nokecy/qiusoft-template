...
export const formId: string = "Wms.LotAttrGroup";
          ...
          "w7fapntoi4p": {
            ...
            "properties": {
              "items": {
                ...
                "x-validator": [],
                "x-component-props": { "gridKey": "appWMS.baseInfo.lotAttrGroup.components.schema.1" },
                "x-decorator-props": {},
                "title": "批次属性",
                "name": "items",
                ...
                "items": {
                  ...
                  "properties": {
                    "1dsacfbnf2p": {
                      ...
                      "x-index": 0,
                      "properties": {
                        "{value:lotAttrItemId,label:lotAttrItemLabel}": {
                          "x-decorator": "FormItem",
                          ...
                          "x-decorator-props": {},
                          "name": "{value:lotAttrItemId,label:lotAttrItemLabel}",
