...
import { PriceClauseGetListAsync } from '@/services/common/PriceClause';
...
const getData = ({ Filter, SkipCount, MaxResultCount, Sorting }: any) => {
  return PriceClauseGetListAsync({
  ...
  return (
    <span ref={ref}>
      <DialogSelect
        ...
        request={getData}
        columnDefs={[
          { field: 'code', headerName: '价格条款代码', width: 120 },
          { field: 'name', headerName: '价格条款名称', width: 150 },
...
export default React.forwardRef(PriceClauseSelect);